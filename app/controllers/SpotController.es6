...
class SpotController {
    ...
    constructor($rootScope, $scope, $routeParams, $location, SpotService) {
...
app.controller("SpotController", ['$rootScope', '$scope', '$routeParams', '$location', 'SpotService', SpotController]);
